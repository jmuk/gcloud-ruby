    ...
    module Monitoring
      module V3
        ...
        class GroupServiceApi
          ...
          #   group_service_api.list_groups(formatted_name, children_of_group, ancestors_of_group, descendants_of_group).each do |element|
          #     # Process element.
          #   end
          #
          #   # Or iterate over results one page at a time.
          #   group_service_api.list_groups(formatted_name, children_of_group, ancestors_of_group, descendants_of_group).each_page do |page|
